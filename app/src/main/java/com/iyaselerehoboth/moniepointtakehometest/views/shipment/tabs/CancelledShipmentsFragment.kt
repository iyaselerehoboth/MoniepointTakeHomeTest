...
import com.iyaselerehoboth.moniepointtakehometest.databinding.FragmentCancelledShipmentsBinding
import com.iyaselerehoboth.moniepointtakehometest.views.shipment.ShipmentAdapter


class CancelledShipmentsFragment : Fragment() {

    private lateinit var binding: FragmentCancelledShipmentsBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_cancelled_shipments, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        db.shipmentDao().getShipmentsByStatus("cancelled").observe(viewLifecycleOwner) {
